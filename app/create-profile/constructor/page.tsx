...
// POST /api/service-providers with capability: 'constructor'
// working city + completed projects have no BE field — TODO when BE adds them
...
const ROLE_DESC = 'Manage construction projects, coordinate teams, track progress, and deliver cafe builds on time and on budget.'

export default function CreateProfileConstructorPage() {
  const router = useRouter()
  const [selectedRole, setSelectedRole] = useState<string>('constructor')
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    if (!studioName.trim()) { setError('Company name is required'); return }
      ...
      <main className="flex flex-1 justify-center px-6 pt-10 pb-16">
        <div className="w-full max-w-[600px]">
          ...
          <div className="relative flex items-center my-6">
            ...
            <span className="mx-3 text-xs font-medium" style={{ color: '#5b483f' }}>Profile information — Constructor</span>
            <div className="flex-1 h-px" style={{ backgroundColor: '#d4c8be' }} />
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex gap-4">
              <div className="flex-1 flex flex-col gap-1.5">
                <label className="text-xs font-medium" style={{ color: '#2d1e14', lineHeight: '19.5px' }}>Company / Personal brand</label>
                <div className="h-9 rounded-lg border px-3 flex items-center" style={{ backgroundColor: 'rgba(212,200,190,0.2)', borderColor: '#d4c8be' }}>
                  <input
                    ...
                    placeholder="e.g. Atelier Build Co."
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="h-9 rounded-lg border px-3 flex items-center" style={{ backgroundColor: 'rgba(212,200,190,0.2)', borderColor: '#d4c8be' }}>
                <input
                  ...
                  placeholder="e.g. Café fit-out & interior construction"
                  className="w-full bg-transparent text-sm outline-none"
                  style={{ color: '#2d1e14' }}
                />
              </div>
            ...
            >
              {loading ? 'Setting up…' : 'Complete as Constructor'}
