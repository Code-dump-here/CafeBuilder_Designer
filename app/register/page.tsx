          ...
          <div className="w-full max-w-[400px]">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm leading-5" style={{ color: '#5b483f' }}>
                Start designing your dream coffee shop today
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium" style={{ color: '#2d1e14', lineHeight: '19.5px' }}>Full name</label>
              ...
              {/* Phone */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium" style={{ color: '#2d1e14', lineHeight: '19.5px' }}>Phone number</label>
                <div className="h-9 rounded-lg border px-3 flex items-center" style={{ backgroundColor: 'rgba(212,200,190,0.2)', borderColor: '#d4c8be' }}>
                  <input
                    type="tel"
                    value={phone}
            ...
            <p className="text-xs text-center mt-6" style={{ color: '#5b483f' }}>
              ...
              <Link href="/sign-in" className="font-medium" style={{ color: '#2d1e14' }}>Sign in</Link>
            </p>
          </div>
